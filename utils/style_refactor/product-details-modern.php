...
<head>
    ...
    <meta name="Description" content="Berkeley County Store - Product Details" />
    <title>BC Store - Product Details</title>
    ...
    <!-- Keep existing functionality scripts -->
    ...
    <script>
        ...
        function calculateNewTotal() {
            ...
            if (newTotalInSummary && totalInSummary) {
                ...
                newTotal = (cartTotal + unDollar(totalInSummary.textContent));
