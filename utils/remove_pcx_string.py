...
def remove_pc_prefix_from_gif_files(folder_path):
    for filename in os.listdir(folder_path):
        if filename.endswith('.gif') and filename.startswith('pc'):
            ...
            if dash_index != -1:  # If '-' is found after 'PC'
                ...
                print(f"Remove pcx string renamed: {filename} to {new_filename}")
