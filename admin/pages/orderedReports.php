...
<body>
    <div id="container">
        ...
        <div id="wrapper">
            <div id="content">
                <h2><strong>Berkeley County Store- All Ordered Requests</strong></h2>
                <h2><strong>Total Number of Items being ordered: <?php echo $TOTALQNT ?></strong></h2>
                <?php
                echo "<p>";
                echo "<table>";
                echo "<tr>";
...
JOIN dep_ref dr on o.department = dr.dep_num
WHERE status = 'Ordered' GROUP BY product_code, size_name, color_id ORDER BY SUM(o.quantity) DESC";
                if ($ROLE === "Administrator") {
                    // Fast Query if your are an admin
                } else {
