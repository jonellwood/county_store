...
<body>
    <div id="container">
        ...
        <div id="wrapper">
            <div id="content">
                <h2><strong>Berkeley County Store- All Approved Requests</strong></h2>
...
JOIN dep_ref dr on o.department = dr.dep_num
WHERE status = 'Approved' GROUP BY product_code, size_name, color_id ORDER BY SUM(o.quantity) DESC";
                if ($ROLE === "Administrator") {
                    // Fast Query if your are an admin
                } else {
                    $sql .= "AND dr.dep_head OR dr.dep_assist = $DEPT";
