        ...
        async function getOrdersByDepartment(department, status) {
            ...
            await fetch('../../reports/getOrdersByDept.php?department=' + department + '&status=' + status)
                ...
                .then((data) => {
                    ...
                    html += '<thead><tr>'
                    html +=
                        '<th>Order ID</th><th>Order Details ID</th><th>Requested For</th><th>Style #</th><th>Size</th><th>Color</th><th>Qty</th><th>Product Price</th><th>Tax</th><th>Line Item Total</th><th colspan="2">Logo</th><th>Date Created</th><th>Status</th><th>Vendor</th>'
                    html += '</tr></thead>'
                    html += '<tbody>';
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<td>' + data[i].requestedFor + '</td>';
