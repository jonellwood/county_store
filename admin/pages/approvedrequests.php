...
$sql = "SELECT SUM(quantity) as TOTALQNT
                ...
                WHERE status = 'Approved' AND department = 41507";
...
<body>
    <div id="container">
        ...
        <div id="wrapper">
            <div id="content">
                <h2><strong>All Approved Requests For Real Property Services</strong></h2>
                <h2><strong>Total Number of Approved Requests: <?php echo $TOTALQNT ?></strong></h2>
                <?php
                echo "<p>";
                echo "<table>";
                echo "<tr>";
                ...
                JOIN dep_ref dr on o.department = dr.dep_num
                WHERE status = 'Approved' and department = 41507
                GROUP BY product_code, size_name, color_id ORDER BY SUM(o.quantity) DESC";
                if ($ROLE === "Administrator") {
                    // Fast Query if your are an admin
                } else {
                ...
                <?php
                $sql = "SELECT o.size_name, o.color_id, o.rf_first_name, o.rf_last_name, o.emp_id, o.product_name, o.created, o.requested_by_name, 
                o.quantity, o.department, o.logo, o.product_code
                FROM uniform_orders.ord_ref o
                WHERE status = 'Approved' and department = 41507";
                if ($ROLE === "Administrator") {
                    // Fast Query if your are an admin
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $SIZE = $row["size_name"];
                        $COLOR = $row["color_id"];
                        $EMP_F_NAME = $row["rf_first_name"];
                        $EMP_L_NAME = $row["rf_last_name"];
                        ...
                        echo "<th width=50%>$EMP_F_NAME $EMP_L_NAME";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>Department</td>";
                        echo "<td>Real Property Services</td>";
                        echo "</tr>";
                        echo "<tr>";
