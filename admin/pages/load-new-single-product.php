...
$sql = "SELECT p.product_id, p.code, p.name, p.name, p.description, pt.producttype as producttype from products_new p
...
JOIN producttypes pt on pt.productType_id = p.product_type
