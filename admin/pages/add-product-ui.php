        ...
        <div class="div2">
            ...
            <div class="container" id="container">
                <div class="header-holder">
                    <h3>Add Product To Store Database</h3>
                ...
                <form name="addProduct" id="addProduct" action="add-product-to-db.php" method="POST"
                    ...
                    <div class=" form-row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <input type="text" class="form-control mb-2 wide-form-control" id="description"
                                name="description" placeholder="Enter Product Description" maxlength="255">
                        </div>
                        <div class="col-auto options">
                            ...
                            <a href="find-price-mod-ui.php" target="_blank"><button type="button"
                                    class="find_mod_btn">Find
                                    Price Mod</button></a>
                        </div>
                        <hr>
                        <div>
                            <h5>Select Filter Tags for this Product. Every product must have one of these options or the
                                world
                                will explode.</h3>
                                <?php
                        ...
                        <div class="col-auto">
                            ...
                            <p><i class="fa fa-hand-point-right"></i>Colors can be added to this page from the Product
                                Admin
                            ...
                            <button type="button" onclick="hideUnchecked()" id="verifyButton">Verify Size & Color
                                Selections</button>
                            <button type="button" onclick="showAllCheckboxes()" id="showallButton" class="hidden">Edit
                                Size
                                or
                        ...
                        <hr>
                        <div class="form-group">
                            <p>Product Image should be 1200 x 1800 when possible. Image name can only be
                                productCode.jpg.
                            </p>
