...
ord_ref.product_name, ord_ref.product_code, ord_ref.vendor, ord_ref.size_name,  ord_ref.status, 
ord_ref.dep_name, MAX(comments.submitted) as last_contact
from ord_ref 
JOIN comments on comments.order_details_id = ord_ref.order_details_id
where ord_ref.order_id = $id 
