<?php
// SanMar Product Scraper - LOCAL DEVELOPMENT VERSION (No Auth)
// This version is for local development only - authentication disabled

// For local development, we'll simulate a logged-in admin user
$_SESSION = [
    'loggedin' => true,
    'role_id' => 1,
...
<head>
    ...
    <title>SanMar Product Scraper - LOCAL DEV</title>
...
<body>
    ...
    <div class="dev-banner">
        🛠️ LOCAL DEVELOPMENT MODE - Authentication Disabled 🛠️
    </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2><i class="fas fa-download me-2"></i>SanMar Product Scraper <small class="text-muted">(Local Dev)</small></h2>
                        <div>
                            <a href="test-images.php" class="btn btn-info me-2">
                                <i class="fas fa-images me-1"></i>Test Downloaded Images
                            </a>
    ...
    <script src="product-scraper-dev.js"></script>
</body>
