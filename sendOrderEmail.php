...
// IN THE MORNING FIGURE OUT HOW TO READ THIS INTO THE BODY
...
try {
    ...
    // if ($orderInfo["submitted_by_email"] != $orderInfo["email"]) {
    //     $mail->addAddress($orderInfo["email"], $orderInfo["submitted_for"]);
    // };
    $mail->addAddress($orderInfo["submitted_by_email"], ($orderInfo["submitted_by"]));
