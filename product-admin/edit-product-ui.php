...
function setCurrentProducttype(id) {
    // console.log('current product type id is: ' + id);
...
function setCurrentVendor(id) {
    // console.log('curretn vendor is: ' + id);
...
function setCurrentColors(colors) {
    if (!Array.isArray(colors)) {
        console.error("setCurrentColors: colors is not an array");
        return;
    }
