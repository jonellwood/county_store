                ...
                .then((data) => {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        <div class="button-holder">
                            ...
                            <button class="btn btn-info goBtn" value="product-details.php?product_id=${data[i].product_id}" onclick="gotoPage(this.value)">Details</button>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row col-lg-12 products-container grid--big-columns" id="products-container">
            ...
            <!-- <div class=product-card-holder id="product-card-holder">
                <div class="card home-product-info" id="featured-card" value="</?php echo $row['product_id'] ?>" data-gender="</?php echo $filterRow['gender'] ?>" data-type="</?php echo $filterRow['type'] ?>" data-size="</?php echo $filterRow['size'] ?>" data-sleeve="</?php echo $filterRow['sleeve'] ?>">
                ...
                <div class="button-holder">
                    ...
                    <button class="btn btn-info goBtn" value="product-details.php?product_id=</?php echo $row["product_id"]; ?>" onclick="gotoPage(this.value)">Details</button>
                    
                </div>
            </div> -->
            </?php } } else { include "product-type-not-found.php" ; ?>
            <!-- <p>Product(s) not found....</p> -->
            </?php } // $conn->close();
            ?>
        </div>
        <div class="button-holder">
            <a href="index.php"><button class="btn btn-secondary" type="button"><i class="fa fa-arrow-left" aria-hidden="true"></i> Continue
                    Shopping </button></a>
    ...
    <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
        <div class="offcanvas-body" id="offcanvas-body">
            ...
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close" id="close-filters-box"></button>
