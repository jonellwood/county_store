...
<head>
    ...
    if ($ROLE === "Administrator") {
        $sql = "SELECT ord.status, ord.size_id, ord.color_id, ord.emp_id, ord.created, ord.quantity, ord.order_details_id, ord.line_item_total, ord.product_name, ord.product_price, ord.product_code, ord.vendor,
                                    ...
                                    COUNT(ord.order_details_id) as PENDINGCOUNT, COUNT(DISTINCT ord.emp_id) as EMPLOYEES, COUNT(DISTINCT d.dep_name) as DEPT
                                    FROM ord_ref ord 
    ...
    <script>
        function updateDenied(id) {
            ...
            // Make the request to denied.php endpoint with the given ID as the query string parameter 
            ...
            // consider moving the ajax.send call to here to improve performance? Remove the blocking until send is completed (also suggest refactoring to use fetch API instead of AJAX...)
        }
    </script>
</head>
                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>
                                ...
                                <?php echo $EMPLOYEES ?> Employees Across <?php echo $DEPT ?> Departments
                            </h6>
                        </div>
