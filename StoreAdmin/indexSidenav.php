...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="../index.php" target=" _blank">
            <img src="../../storeadmin/assets/img/bcg12.png" class="navbar-brand-img h-50" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="../../StoreAdmin/index.php">
            ...
            <li class="nav-item">
                <a class="nav-link " href="./pages/orders-by-dept-for-admin.php">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link " href="./pages/received.php">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="./pages/completed.php">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link " href="./pages/overview.php">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link "
                    href="https://www.printavo.com/customer/def1e1df42285405079c0bcd919c20d0?preauth=eyJhbGciOiJSUzI1NiJ9.eyJleHAiOjE2Nzk1ODUzNTgsImlzcyI6NjUzNjI0MCwidmVyIjoiY3VzdG9tZXItcHJlYXV0aC12MSIsIm9yZGVyX2lkIjpudWxsfQ.LxvAWRgdht9WXPGpj9Vuj6CqGvT1qNZNuua2M_DXEIBIuPoFEngk14Kj0lcxAq3g_X-tROTCf2YoDYcHt1wGiNGwWxzHHs5wv-oDMGMg4L5lTYSrLH3KSfPFa8E_FdB9J5niWOoJjPS8MVVqnIVM3tgYevP04Mvxtm8L1eEmIZoo3k0o92XevUOa1gFAHd257IjgLmCPpnJ58BhEn_8LM5c5FtAFWXIO6RgdFcLvQZiB1CvaoSRK-lhxnnol18Jv1s1ljTaRID9isPnsPGt9xQW46zIuxjpaFUrZQ5nxEzWuFJp3UZtlSCZClFJliHYbXxULowSWV1ERD48a8nqlyQ"
                    target="_blank">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-chart-bar-32 text-danger text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">LC Native Portal</span>
                </a>
            </li>
            <!-- <li class="nav-item">
        ...
        <div class="card card-plain shadow-none" id="sidenavCard">
            ...
            <div class="card-body text-center p-3 w-100 pt-0">
                <div class="docs-info">
                    ...
                    <p class="text-xs font-weight-bold mb-0"><a href="./assets/img/Berkeley County Employee Store.pdf"
                            target="_blank"><u>County Store Manual</u></p></a>
                </div>
            </div>
        </div>
    </div>
