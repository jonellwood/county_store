    ...
    function editProduct(id) {
        ...
        fetch('load-new-single-product.php?id=' + id)
            ...
            .then((data) => {
                ...
                vHtml +=
                    '<table class="styled-table"><caption>Unchecking the checkbox will remove that line item from the database</caption><thead><th>Vendor Name</th><th>Size</th><th>Price</th><th colspan="2">Is Active</th></thead><tbody>';
                for (var i = 0; i < data[2].current_prices_and_sizes.length; i++) {
                    ...
                    for (var s = 0; s < data[5].all_sizes.length; s++) {
                        ...
                        vHtml +=
                            `<option value=${data[5].all_sizes[s].size_id} ${isSelected}>${data[5].all_sizes[s].size_name}</option>`;
                    }
                ...
                aHtml +=
                    '<table class="styled-table"><thead><th>Vendor Name</th><th>Size</th><th>Price</th></thead><tbody>'
                aHtml += `<tr>
                ...
                for (var k = 0; k < data[5].all_sizes.length; k++) {
                    aHtml +=
                        `<option value=${data[5].all_sizes[k].size_id}>${data[5].all_sizes[k].size_name}</option> `
                }
                aHtml += `</select>
                            </td>
