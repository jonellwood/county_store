                        ...
                        if (Object.prototype.hasOwnProperty.call(data, key)) {
                            ...
                            employeeData.departments.forEach((department) => {
                                ...
                                if (department.dep_name_1) {
                                    departmentText += `Dept Head: ${department.dep_name_1} - ${department.dep_num_1}<br>`;
                                }
                                if (department.dep_name_2) {
                                    departmentText += `Dept Asst: ${department.dep_name_2} - ${department.dep_num_2}<br>`;
                                }
                                if (department.dep_name_3) {
                                    departmentText += `Dept Asset Mgr: ${department.dep_name_3} - ${department.dep_num_1}<br>`;
                                }
