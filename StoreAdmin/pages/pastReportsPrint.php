...
if ($ROLE === "Administrator") {
    ...
    RIGHT JOIN ord_ref ON order_inst_order_details_id.order_details_id = ord_ref.order_details_id
    RIGHT JOIN dep_ref ON ord_ref.department = dep_ref.dep_num
    ...
    <div id="container">
        ...
        <div id="wrapper">
            <div id="content">
                ...
                if ($ROLE === "Administrator") {
                    $sql = "SELECT order_inst_order_details_id.order_inst_id, ord_ref.product_code, ord_ref.size_name, ord_ref.quantity, ord_ref.color_id
                    FROM uniform_orders.order_inst_order_details_id
                    RIGHT JOIN ord_ref ON order_inst_order_details_id.order_details_id = ord_ref.order_details_id
                    RIGHT JOIN dep_ref ON ord_ref.department = dep_ref.dep_num
                    -- RIGHT JOIN order_details ON ord_ref.order_id = order_details.order_id
...
ORDER BY ord_ref.color_id";
                ...
                if ($ROLE === "Administrator") {
                    ...
                    ord_ref.order_details_id, ord_ref.quantity, ord_ref.size_name, ord_ref.color_id, ord_ref.emp_id, ord_ref.dept_patch_place,
                    ord_ref.rf_first_name, ord_ref.rf_last_name, ord_ref.logo, dep_ref.dep_name, order_details.comment
                    FROM uniform_orders.order_inst_order_details_id
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>Comment from Requestor</td>";
                        echo "<td>$COMMENT</td>";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>Display Department Name</td>";
                        echo "<td>$DEPT_PATCH</td>";
                        echo "</tr>";
                        echo "<tr>";
