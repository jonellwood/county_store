...
<head>
    ...
    function extractDate(inputString) {
        console.log('extractDateString: ', inputString)
        if (inputString == null) {
            return 'none';
        } else {
    ...
    async function getOptions(prod_id, order_det_id, color_id, size_name, bill_to, currentColor, currentSize) {
        await fetch('./getProductOptions.php?prod_id=' + prod_id)
            ...
            .then((data) => {
                ...
                // formHTML += "</table>";
                formHTML += "</div>";
                document.getElementById('details').innerHTML = formHTML;
...
<body class="p-3 m-0 border-0 bd-example m-0 border-0">
    ...
    function setDefaultColorOption() {
        ...
        // console.log('color select ', select);
    ...
    function setDefaultSizeOption() {
        ...
        // console.log('size select', select);
        // console.log('size options ', options);
        // console.log('current size', currentColor);
