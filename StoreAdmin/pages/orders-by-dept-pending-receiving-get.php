...
$deptList = [];
$sql = "SELECT * FROM uniform_orders.ord_ordered";
...
foreach ($deptList as $department) {
    ...
    $ordSql = "SELECT ord_ref.order_id, ord_ref.quantity, ord_ref.product_name, ord_ref.product_code, ord_ref.color_id, ord_ref.order_details_id,
    ord_ref.size_name, ord_ref.line_item_total, ord_ref.rf_first_name, ord_ref.rf_last_name, ord_ref.department, ord_ref.status, departments.dep_name
    FROM ord_ref 
