        ...
        await fetch('getOrderDetails.php?id=' + order_id)
            ...
            .then((data) => {
                ...
                for (var j = 0; j < data.length; j++) {
                    ...
                    grogu += "<td id='prod_img_" + [j] + "'><img class='img prod_img' src=../../" +
                        formatValueForUrl(data[j].product_image) + " alt='..' width='50px'/></td>";
                    grogu += "</tr>";
                    // grogu +=
                ...
                function makeReceiveButtons() {
                    ...
                    recButtons += "<button class='approve' value='" + order_id +
                        "' onclick='receiveWholeOrder(this.value)'>Receive All</button>";
                    recButtons +=
...
<body onload="getRequests()">
    <div class="parent">
        ...
        <div class="div2" id="main" data-title="Orders List"
            data-intro="These are all the orders submitted for your department(s). Each order most likely has several line items in each one."
            data-step="6">
        </div>
        <div class="div3" id="details" data-title="Detailed Order Info"
            data-intro="These are the specific items requested by the employee. You can approve or deny them all at once using the button to the left; or one at time by clicking a specific line item. When selecting a specific line item a popup menu will allow you to make decisions on the specific line item."
            data-step="7">
        </div>
        <div class="div4">
        ...
        <div class="div6 total-hidden" id="totalsOffCanvas">
            <div class="div5" id="depTotals" data-title="Department and Employee Information"
                data-intro="Here you can see Fiscal Year data for your Department as well as detailed information about the employee for whom this request has been submitted. Values are broken out by status as well if the request is for clothing or boots."
                data-step="8">
            </div>
        </div>
        <div class="div7 hidden" id="showTotalsButton" data-title="Toggle View"
            data-intro="Need more screen space? Toggle the view for Department and Employee Totals here" data-step="5">
