...
$sql = "SELECT xs_inc, s_inc, m_inc, l_inc, xl_inc, xxl_inc, xxxl_inc, xxxxl_inc, xxxxxl_inc, xxxxxxl_inc, lt_inc, xlt_inc, xxlt_inc, xxxlt_inc, xxxxlt_inc, na_inc FROM price_mods LIMIT 1";
...
while ($row = $result->fetch_assoc()) {
    ...
    if ($row_array == $size_mod_array) {
        ...
        $sql = "SELECT xs_inc, s_inc, m_inc, l_inc, xl_inc, xxl_inc, xxxl_inc, xxxxl_inc, xxxxxl_inc, xxxxxxl_inc, lt_inc, xlt_inc, xxlt_inc, xxxlt_inc, xxxxlt_inc, na_inc FROM price_mods LIMIT 1 OFFSET $i";
        $result = $conn->query($sql);
