...
$sql = "SELECT * FROM uniform_orders.products p join (select * from producttypes) t
on p.producttype=t.productType_id
            ...
            <div class=product-card-holder>
                ...
                <div class="button-holder">
                    ...
                    <button class="btn btn-info goBtn"
                        value="product-details-onefee.php?product_id=<?php echo $row["product_id"]; ?>"
