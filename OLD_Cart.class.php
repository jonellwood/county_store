...
class Cart
{
    ...
    /**
     * Returns the entire cart array arranged by newest items first.
     * It removes the 'total_items' and 'cart_total' keys from the array 
     * as they cause problems when showing the cart table.
     *
    ...
    public function contents()
    {
        ...
        // Remove these values because they create a problem when showing the cart table
    ...
    protected function save_cart()
    {
        ...
        foreach ($this->cart_contents as $key => $val) {
            ...
            $this->cart_contents[$key]['logoFeeSubtotal'] = ($this->cart_contents[$key]['logoFee'] * $this->cart_contents[$key]['qty']);
            $this->cart_contents[$key]['subtotalWithLogoFee'] = ($this->cart_contents[$key]['subtotal'] + $this->cart_contents[$key]['logoFeeSubtotal']);
        }
