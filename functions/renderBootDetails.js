function renderBootDetails(data) {
	var nameHtml = `
	...
	html += `<input type="hidden" name="logo-url" id="logo-url" value='dept_logos/empty.png' />`;
	...
	summaryHtml = `<div id="selection-summary">
                               ...
                               <div id='selected-logo-in-summary' class="hidden">
