...
<body class="log-in-body">
    <div class="make-blurry">
        <div class="log-in-image">
            <img src="../dept_logos/saveInCase/blue-seal.png" alt="bcg logo" width="150px">
        </div>
        <h1 class="log-in-h1">Inventory Management System</h1>
...
<style>
    ...
    .log-in-body {
        ...
        background-image: url(./assets/inv-mgmt.jpg);
