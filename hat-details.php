...
<head>
    ...
    function updateProductImage(val) {
        ...
        var newProductImage = formatColorValueForUrl(val) + '_' + productCode.toLowerCase() + '.jpg';
    ...
    <div class="container">
        ...
        <div class="another-container">
            ...
            <span class='product-image-holder'>
                <!-- <figure> -->
                <img src="product-images/<?php echo $code ?>_prod.jpg" alt="<?php echo $row['name'] ?>"
                    class="product-image">
            ...
            <div class="details-about-details">
                ...
                <div class="logo-img-holder logo-hide" id="logo-img-holder">
                    <figure>
                        <img src="./dept_logos/Seal_White_Dept.png" alt="bc logo" id="logo-img">
                        <p id="logo-desc"></p>
