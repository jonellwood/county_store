...
<script src="./functions/renderHatDetails.js"></script>
...
function updateCurrentQty() {
    ...
    //     var target = document.getElementById('#new-total-in-summary');
    //     document.target.animate({
    //         duration: 300,
    //         easing: 'ease-in-out',
    //         pseudoElement: "::view-transition-new(summary-transition))"
    //     })
    //     var t2 = document.getElementById('#total-in-summary');
    //     document.t2.animate({
    //         duration: 300,
    //         easing: 'ease-in-out',
    //         pseudoElement: "::view-transition-new(summary-transition))"
...
function updateProductImage(val) {
    ...
    var productImage = document.querySelector('.hat-image');
...
<body class="body">
    <div class="container" id="container">
        ...
        <div class="another-container" id="another-container">
            ...
            <span class='hat-image-holder' id='product-image-holder' view-transition-group="image-transition"
                anchorName="image-holder"></span>
...
function adustHatImageSize() {
    ...
    if (product_id == 33) {
        ...
        img.style = "width: 70%; clip-path: inset(7% 7% 44% 7%);";
    } else if (product_id == 191) {
        img.style = "width: 70%; clip-path: inset(7% 7% 46% 7%);";
    }
}
</script>
