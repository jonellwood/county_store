...
$sql = "SELECT * FROM uniform_orders.products where products.isactive = '1' AND products.name LIKE '%$search_param%'
or products.isactive = '1' AND products.code like '%$search_param%'";
