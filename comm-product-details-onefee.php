<?php
// check if the isComm flag is set to True
function checkisComm()
{
    session_start();
    if (!isset($_SESSION['isComm'])) {
        $_SESSION['isComm'] = false;
    } else {
...
<head>
    ...
    function updateColorImage(val) {
        ...
        checkProduct(<?php echo $product_id ?>);
    }
...
<body onload="setProductPriceValue()">
    ...
    <div class="container">
        ...
        <div class="product-name-holder-stretched">
            ...
            <p class="spec-sheet-download-link"><a href="spec-sheets/<?php echo $row['code'] ?>.pdf"
                    download="<?php echo $row['code'] ?>.pdf"><b>Download Spec Sheet</b></a></p>
        </div>
        <div class="another-container">
            ...
            <div class="details-about-details">
                ...
                <div class="options-form-holder">
                    <form name="options" method="post" id="options" action="cartAction.php"
                        ...
                        <div class="logo-info-holder">
                            ...
                            <?php
                                    $logosql = "SELECT logo_name, image, id, description FROM uniform_orders.logos WHERE isactive = '1' AND iscomm = '1'";
                ...
                <div class="logo-img-holder">
                    <figure>
                        <img src="./dept_logos/comm.png" alt="Comms logo" id="logo-img">
                        <p id="logo-desc"></p>
                        <figcaption>Logo show is for display purposes only. Actual color will look differnt. If you do
                            not get your hopes up, you can not be let down</figcaption>
                    </figure>
                </div>
            </div>
            <?php }
        ...
        <div class="button-holder">
            ...
            <button type="submit" form="options" class="btn btn-primary custom-btn" id="add-to-cart-button"><span><i
        ...
        <div id="myToast">
            <div class="toast-header">
                <i class="fa fa-info"></i>ATTENTION PLEASE
...
function alertIfColorIsRestricted() {
    ...
    if (allowedColors.includes(colorInput)) {
        ...
        showToast(
            'The only colors approved for this product are Graphite Heather, Navy, Carolina Blue, Black, and Heliconia. And YES, I agree, we should only show you those colors then - but I am not that good at coding. Yet.'
        )
