...
<head>
    ...
    <script>
        ...
        function showSpendingToast() {
            ...
            setTimeout(hideSpendingToast, 5000);
        }
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-center">
                <ul class="list-unstyled mb-0">
                    <li>
                        <a href="https://store.berkeleycountysc.gov/index.php" target="_blank"><i class="fas fa-home fa-2x"></i>
                    ...
                    <li onclick=seeSpending()>
                        <i class="fas fa-piggy-bank mt-4 fa-2x clickable"></i>
                        <p class='clickable'>See my Spending</p>
                    </li>
                    ...
                    <li>
                        <a href="https://store.berkeleycountysc.gov/inventory/login-ldap.php" target="_blank"><i class="fas fa-warehouse mt-4 fa-2x"></i>
                    ...
                    <li>
                        <a href="./changelogView.php">
                            <i class="fas fa-list mt-4 fa-2x"></i>
                            <p>Change Log</p>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.companycasuals.com/LOWCOUNTRYNATIVE//start.jsp" target="_blank"><i class='fas fa-store-alt mt-4 fa-2x'></i></a>
                        <p>LowCounty Native </p>
                    </li>
                </ul>
            </div>
            <!--Grid column-->
